  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ajouter bon</h5>
    ...
    <div class="row col-sm-6" id="ligne">
      <form>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInput" placeholder="Entrez la designation">
        </div>
        <div class="form-group">
            <label for="exampleInput"><strong>Date payment:</strong></label>
            <input type="date" class="form-control" id="exampleInput" placeholder="Entrez la date du payement">
        </div>
