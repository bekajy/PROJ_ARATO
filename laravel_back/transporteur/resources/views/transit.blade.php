  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ajouter transit</h5>
    ...
    <div class="row col-sm-6" id="ligne">
      <form>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="exampleInput" placeholder="Entrez le nom">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="exampleInput"><strong>RC:</strong></label>
            <input type="text" class="form-control" id="exampleInput" placeholder="Entrez le RC">
        </div>
        <div class="form-group">
            <label for="exampleInput"><strong>Adresse:</strong></label>
            <input type="text" class="form-control" id="exampleInput" placeholder="Entrez votre adresse">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="exampleInput"><strong>Ordre:</strong></label>
            <input type="number" class="form-control" id="exampleInput" placeholder="Entrez votre Ordre">
        </div>
