  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ajouter model</h5>
  ...
  <div class="jumbotron">
    <div class="row col-sm-6" id="ligne">
      <form>
        ...
        <div class="form-group">
            <label for="exampleInput"><strong>Model:</strong></label>
            <input type="text" class="form-control" id="exampleInput" placeholder="Entrez le model">
        </div>
